      ...
      <div className="min-h-screen bg-brand-dark flex items-center justify-center p-8 relative overflow-hidden font-sans">
        ...
        <div className="relative z-10 w-full max-w-[440px] bg-white/[0.04] backdrop-blur-xl border border-white/10 rounded-3xl p-10 animate-slideUp">
          ...
          <p className="text-sm text-white/45 mb-8">
            Join thousands topping up smarter
          </p>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-brand-primary to-brand-primaryDark text-white font-bold text-[15px] py-3.5 rounded-xl flex items-center justify-center gap-2 hover:opacity-90 hover:-translate-y-px active:translate-y-0 transition-all disabled:opacity-50 disabled:cursor-not-allowed mt-2"
            >
              <svg
                width="16"
                height="16"
